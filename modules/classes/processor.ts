...
import { ErrorRegistryInput, StageMap, ProcessorDefinition, Runtime, ProcessorResult, ExecutedStepRecord, ExecutedStageRecord, CompensationFailure, CommonRuntimeFlags, CollapseLevel } from "../types";
...
> {
  ...
  /**
   * Walk executed steps and stages in reverse order, running compensators.
   */
